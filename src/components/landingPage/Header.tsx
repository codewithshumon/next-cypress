    ...
    <header className="p-4 flex items-center justify-center">
      <Link href={'/'} className="w-full flex justify-left items-center gap-2">
        <Image
          ...
          height={25}
        />
        <span className="font-semibold dark:text-white">nextCypress</span>
      </Link>
            ...
            <NavigationMenuContent>
              <ul className="grid gap-3 p-6 md:w-[400px] ld:w-[500px] lg:grid-cols-[.75fr_1fr]">
                <li className="row-span-3">
                  <span className="flex p-6 w-full h-full select-none flex-col justify-center rounded-md bg-gradient-to-b from-muted/50 to-muted no-underline focus:shadow-md">
                    Welcome
                  </span>
                </li>
    ...
    <li>
      <NavigationMenuLink asChild>
        <a
          ...
          {...props}
        >
          <div className="font-medium leading-none text-white text-sm">
            {title}
          </div>
          <p className="group-hover:text-white/70 line-clamp-2 text-sm leading-none text-white/40">
            {children}
          </p>
        </a>
      </NavigationMenuLink>
